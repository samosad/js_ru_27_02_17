import {DELETE_ARTICLE, ADD_COMMENT, LOAD_ALL_ARTICLES, LOAD_ARTICLE_BY_ID, LOAD_COMMENTS_BY_ARTICLE_ID,
...
export default (state = new DefaultReducerState(), action) => {
    ...
    switch (type) {
        ...
        case LOAD_COMMENTS_BY_ARTICLE_ID + FAIL:
            return state.setIn(['entities', payload.id, 'loadingComments'], false)
    }
